...
#brand-logo{
  ...
  filter:drop-shadow(0 0 6px rgba(122,255,80,.35)) drop-shadow(0 0 14px rgba(0,255,163,.18));
  image-rendering:auto;
  transition:filter .25s ease,transform .25s ease;
}
#brand-logo:hover{
  filter:drop-shadow(0 0 10px rgba(122,255,80,.65)) drop-shadow(0 0 22px rgba(0,255,163,.35));
